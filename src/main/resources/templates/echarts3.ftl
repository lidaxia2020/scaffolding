...
<div class="x-body">
    <blockquote class="layui-elem-quote">
        ...
        Canvas 类库 ZRender，提供直观，生动，可交互，可高度个性化定制的数据可视化图表。如需使用或者详细更多案例可以访问官网 <a href="http://echarts.baidu.com/"
...
<script src="${ctxPath}/static/js/bmap.min.js" type="text/javascript"></script>
